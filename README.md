...
지도 기반 서비스와 관리 시스템을 중심으로 프론트엔드 개발 경험을 쌓아온 개발자입니다. 전체 개발 조직에서 JavaScript/TypeScript 분야의 기술 리딩을 담당하며, 월평균 약 50건의 PR 리뷰를 통해 아키텍처와 코드 품질을 관리하고 있습니다.
...
**기간**: 2021.06 ~ 현재 (5년)  
**역할**: JavaScript/TypeScript 프로젝트 기술 리딩 및 핵심 기능 개발
**주요 업무**

- 사내 JavaScript/TypeScript 프로젝트의 기술 방향 및 아키텍처 결정
- 월평균 약 50건의 PR을 리뷰하며 구현 방향 조율 및 코드 품질 관리
